function R_TE = reflectance_TM(n0,nsubs,n_layers,d_layers,theta_in,lambda)
...
Z(1) = cos(theta(1)) * Z0./n(1);
Z(end) = cos(theta(end)) * Z0./n(end);

eta(1) = cos(theta(1)) * Z0./n(1);
eta(end) = cos(theta(end)) * Z0./n(end);
